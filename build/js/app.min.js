...
(function (RunningElderly) {
    RunningElderly.SEGMENT_LENGTH = 60;
    RunningElderly.TRACK_WIDTH = 10;
    RunningElderly.MAX_SEGMENT_NUMBER = 4;
...
(function (RunningElderly) {
    var RoadManager = (function () {
        function RoadManager(scene) {
            var _this = this;
            this.animate = function (keyboard) {
                ...
                _this.segmentIds.forEach(function (segmentId) { return ++_this.scene.getObjectById(segmentId).position.z; });
            };
            this.scene = scene;
    ...
    var RoadTrack = (function (_super) {
        ...
        function RoadTrack(material) {
            _super.call(this);
            var roadSurface = new RoadSurface(material);
    ...
    var RoadTrackLeft = (function (_super) {
        ...
        function RoadTrackLeft() {
            _super.call(this, new THREE.MeshBasicMaterial({
    ...
    var RoadSurface = (function (_super) {
        ...
        function RoadSurface(material) {
            _super.call(this, new THREE.PlaneBufferGeometry(RunningElderly.TRACK_WIDTH, RunningElderly.SEGMENT_LENGTH), material);
    ...
    var RoadObstacle = (function (_super) {
        ...
        function RoadObstacle(index, position) {
...
(function (RunningElderly) {
        ...
        function CharacterManager(scene, keyboard) {
            ...
            this.animate = function (keyboard) {
                if (keyboard.down('left')) {
                    if (_this.character.position.x > -RunningElderly.TRACK_WIDTH)
                        _this.character.translateX(-RunningElderly.TRACK_WIDTH);
                }
    ...
    var Character = (function (_super) {
        ...
        function Character() {
            var geometry = new THREE.PlaneBufferGeometry(RunningElderly.TRACK_WIDTH, RunningElderly.TRACK_WIDTH);
            var texture = THREE.ImageUtils.loadTexture('build/img/elderly.png');
            ...
            _super.call(this, geometry, material);
            this.position.set(0, RunningElderly.TRACK_WIDTH / 2, RunningElderly.TRACK_WIDTH * 1.8);
        }
        return Character;
    })(THREE.Mesh);
})(RunningElderly || (RunningElderly = {}));
