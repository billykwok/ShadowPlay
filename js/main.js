...
(function() {
    ...
    var populateBones = function() {
        ...
        // torso
        bones.push({
            jointStart: kinect.JointType.head,
            jointEnd: kinect.JointType.neck
        });
        bones.push({
            jointStart: kinect.JointType.neck,
            jointEnd: kinect.JointType.spineShoulder
        });
        bones.push({
            jointStart: kinect.JointType.spineShoulder,
            jointEnd: kinect.JointType.spineMid
        });
        bones.push({
            jointStart: kinect.JointType.spineMid,
            jointEnd: kinect.JointType.spineBase
        });
        bones.push({
            jointStart: kinect.JointType.spineShoulder,
            jointEnd: kinect.JointType.shoulderRight
        });
        bones.push({
            jointStart: kinect.JointType.spineShoulder,
            jointEnd: kinect.JointType.shoulderLeft
        });
        bones.push({
            jointStart: kinect.JointType.spineBase,
            jointEnd: kinect.JointType.hipRight
        });
        bones.push({
            jointStart: kinect.JointType.spineBase,
            jointEnd: kinect.JointType.hipLeft
        });

        // right arm
        bones.push({
            jointStart: kinect.JointType.shoulderRight,
            jointEnd: kinect.JointType.elbowRight
        });
        bones.push({
            jointStart: kinect.JointType.elbowRight,
            jointEnd: kinect.JointType.wristRight
        });
        bones.push({
            jointStart: kinect.JointType.wristRight,
            jointEnd: kinect.JointType.handRight
        });
        bones.push({
            jointStart: kinect.JointType.handRight,
            jointEnd: kinect.JointType.handTipRight
        });
        bones.push({
            jointStart: kinect.JointType.wristRight,
            jointEnd: kinect.JointType.thumbRight
        });

        // left arm
        bones.push({
            jointStart: kinect.JointType.shoulderLeft,
            jointEnd: kinect.JointType.elbowLeft
        });
        bones.push({
            jointStart: kinect.JointType.elbowLeft,
            jointEnd: kinect.JointType.wristLeft
        });
        bones.push({
            jointStart: kinect.JointType.wristLeft,
            jointEnd: kinect.JointType.handLeft
        });
        bones.push({
            jointStart: kinect.JointType.handLeft,
            jointEnd: kinect.JointType.handTipLeft
        });
        bones.push({
            jointStart: kinect.JointType.wristLeft,
            jointEnd: kinect.JointType.thumbLeft
        });

        // right leg
        bones.push({
            jointStart: kinect.JointType.hipRight,
            jointEnd: kinect.JointType.kneeRight
        });
        bones.push({
            jointStart: kinect.JointType.kneeRight,
            jointEnd: kinect.JointType.ankleRight
        });
        bones.push({
            jointStart: kinect.JointType.ankleRight,
            jointEnd: kinect.JointType.footRight
        });

        // left leg
        bones.push({
            jointStart: kinect.JointType.hipLeft,
            jointEnd: kinect.JointType.kneeLeft
        });
        bones.push({
            jointStart: kinect.JointType.kneeLeft,
            jointEnd: kinect.JointType.ankleLeft
        });
        bones.push({
            jointStart: kinect.JointType.ankleLeft,
            jointEnd: kinect.JointType.footLeft
        });
